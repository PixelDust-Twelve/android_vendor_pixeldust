...
SOONG_CONFIG_pixeldustGlobalVars_disable_postrender_cleanup := $(TARGET_DISABLE_POSTRENDER_CLEANUP)
SOONG_CONFIG_pixeldustGlobalVars_has_legacy_camera_hal1 := $(TARGET_HAS_LEGACY_CAMERA_HAL1)
SOONG_CONFIG_pixeldustGlobalVars_has_memfd_backport := $(TARGET_HAS_MEMFD_BACKPORT)
